...
// ProcessLauncher.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CProcessLauncherApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CProcessLauncherApp

CProcessLauncherApp::CProcessLauncherApp()
{
...
// Единственный объект CProcessLauncherApp

CProcessLauncherApp theApp;


// инициализация CProcessLauncherApp

BOOL CProcessLauncherApp::InitInstance()
{
